...
function Tweet({ tweet, page = false }) {
    return (<>
  <figure className="relative rounded-2xl overflow-hidden max-w-xs pb-3 w-full text-left text-gray-800 bg-gray-300  shadow-md">
    ...
    <div className=" pl-[17px] pb-[10px]  text-white uppercase transform translate-y-1/2">

      <h5 className="font-extrabold opacity-80 text-gray-950">
        {tweet?.owner?.fullName}<span className="font-normal normal-case text-gray-800 pl-1"></span>
      </h5>
    </div>
  </figure>
